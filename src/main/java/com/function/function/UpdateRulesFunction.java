...
//         sb.append("    salience ").append(req.priority + req.version).append("\n");
...
//                             String method = (req.actionWarning != null && !req.actionWarning.isBlank()) ? req.actionWarning : "calcWeekdayOvertime";
//                             sb.append("        BigDecimal bonus = com.function.util.RuleUtils.").append(method).append("($emp.getBaseSalary(), $ot.getOvertimeHours());\n");
//                             line(sb, "$result.setOvertimeBonus($result.getOvertimeBonus().add(bonus))");
//                             appendIfNotBlank(sb, req.actionNote, "        $result.addRuleDetail(\"", " +\" + bonus);\n"); break;
//                         }
//                     }
